        ...
        return response()->json([
            'sliders' => $sliders->map(function ($slider) {
                ...
                return [
                    ...
                    'image_scale_x' => (float) ($slider->image_scale_x ?? 1),
                    'image_scale_y' => (float) ($slider->image_scale_y ?? 1),
                    ...
                    'mobile_image_scale_x' => (float) ($slider->mobile_image_scale_x ?? 1),
                    'mobile_image_scale_y' => (float) ($slider->mobile_image_scale_y ?? 1),
